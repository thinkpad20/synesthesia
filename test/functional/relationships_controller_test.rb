...
class RelationshipsControllerTest < ActionController::TestCase
  ...
  test "should create relationship" do
    assert_difference('Relationship.count') do
      post :create, relationship: { followed_id: @relationship.followed_id, follower_id: @relationship.follower_id }
    end
  ...
  test "should update relationship" do
    put :update, id: @relationship, relationship: { followed_id: @relationship.followed_id, follower_id: @relationship.follower_id }
    assert_redirected_to relationship_path(assigns(:relationship))
  end
