...
class SoundsControllerTest < ActionController::TestCase
  ...
  test "should create sound" do
    assert_difference('Sound.count') do
      post :create, sound: { algorithm_name: @sound.algorithm_name, description: @sound.description, name: @sound.name, url: @sound.url }
    end
  ...
  test "should update sound" do
    put :update, id: @sound, sound: { algorithm_name: @sound.algorithm_name, description: @sound.description, name: @sound.name, url: @sound.url }
    assert_redirected_to sound_path(assigns(:sound))
  end
